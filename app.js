...
/* Entrada */
const intro=document.querySelector('#intro'), enter=document.querySelector('#enterStore');
enter.addEventListener('click',()=>{document.body.classList.remove('intro-active');intro.classList.add('exit');setTimeout(()=>intro.remove(),850)});
